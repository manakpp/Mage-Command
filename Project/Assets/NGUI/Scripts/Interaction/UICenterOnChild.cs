...
public class UICenterOnChild : MonoBehaviour
{
	...
	public List<EventDelegate> onNextPage = new List<EventDelegate>();
	public List<EventDelegate> onPreviousPage = new List<EventDelegate>();
	...
	public void Recenter ()
	{
		...
		{
			if(UICamera.currentTouch.totalDelta.x < 0.0f)
			{
				EventDelegate.Execute(onNextPage);
			}
			else if (UICamera.currentTouch.totalDelta.x > 0.0f)
			{
				EventDelegate.Execute(onPreviousPage);
			}
